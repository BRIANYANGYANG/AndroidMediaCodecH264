...
public class CameraSurfaceTextureActivity extends Activity implements CamOpenOverCallback{
	...
	private CameraSurfacePreview  mCameraTexturePreview;
	...
	private void initUI() {
		mCameraTexturePreview = (CameraSurfacePreview ) findViewById(R.id.camera_surfaceview);
	}
	...
	public void cameraHasOpened() {
		SurfaceHolder surface = this.mCameraTexturePreview.getHolder();
